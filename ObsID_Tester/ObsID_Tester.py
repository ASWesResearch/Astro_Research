...
def ObsID_Tester(ObsID_L):
    ...
    for ObsID in ObsID_L:
        ...
        try:
            ...
            if((Num_Rows_in_Array!=1024) or (Exposure_Time<6000) or (Grating_Flag!="NONE") or (READMODE!="TIMED")): #Checks to see if the current observation is invaild (invalid if: it is a subarray or has an exposure time less then 6000s)
