...
def Histogram_Organizer(Gname,D25_Threshold=0.5):
        """
        ...
        if(R>D25_Threshold):
            return True
        return False
        #print "zip(Dec_Match_L,RA_Match_L) : ", zip(Dec_Match_L,RA_Match_L)
        #print "Dec_Match_L : ", Dec_Match_L
        #print "RA_Match_L : ", RA_Match_L
        #print "dec : ", dec
        #print "ra : ", ra
        #print area_A
        #area_max=max(area_A)
        ...
        #print "Path_2=", path_2
        """
#Histogram_Organizer("NGC 0253")
#Histogram_Organizer("NGC 1300")
