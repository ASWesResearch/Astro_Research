...
def Simple_Region_Generator (fname,evtfpath,outpath):
    ...
    for Cur_Reg_Data in Reg_Data: # Selects the current CCD shape polygon
        ...
        hdulist = fits.open(evtfpath) #hdulist:-astropy.io.fits.hdu.hdulist.HDUList, hdulist, The hdulist of the current event 2 file, This will have to be changed to a filepath input inorder to work in the pipeline
        #print type(hdulist)
