...
wavdetect $1 outfile=$2 scellfile=$3_source_cell.fits imagefile=$3_image.fits defnbkgfile=$3_background.fits scales='1 2 4 8' psffile=$4 regfile=$5 interdir=$ASCDS_WORK_PATH clobber=yes verbose=0
#echo $PFILES
