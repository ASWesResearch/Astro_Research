...
#mkinstmap outfile="$1_instmap.fits" monoenergy=2.3 spectrumfile=NONE grating=NONE maskfile=NONE pixelgrid="$2" obsfile="$3" dafile=CALDB detsubsys="ACIS-$7;uniform;bpmask=0" mirror=HRMA mode=h clobber=yes verbose=0
